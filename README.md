...
A simple CoCreate-socket-client component in vanilla javascript. Easily configured using HTML5 data-attributes and/or JavaScript API. Take it for a spin in our [playground!](https://cocreate.app/docs/CoCreate-socket-client)
...
[CoCreate Docs](https://cocreate.app/docs/CoCreate-socket-client)
